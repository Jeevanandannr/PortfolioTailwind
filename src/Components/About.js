    ...
    <section className="flex flex-col md:flex-row px-5 justify-center  bg-secondary">
      ...
      <div className="md:w-1/2 py-5 pt-20 flex justify-center px-10">
        <div className="flex flex-col justify-center font-Hero-font">
          ...
          <h1 className="font-bold font-Hero-font text-3xl text-white border-b-2 w-[300px]">
            My skill set includes
          </h1>
          <p className="text-white m-5">
            <span className="font-bold text-white text-1xl">
              Back-End Development:
            </span>{" "}
            Proficient in C#, ASP.NET Core, Entity Framework, and SQL Server.
          </p>
          <p className="pb-5 text-white m-5">
            <span className="font-bold text-white text-1xl">
              Front-End Development:
            </span>{" "}
            Skilled in HTML, CSS, JavaScript, and modern framework React.
          </p>
          <p className="pb-5 text-white m-5">
            <span className="font-bold text-white text-1xl">
              API Development:
            </span>{" "}
            Experienced in building RESTful APIs and integrating third-party
            services.
          </p>
          <p className="pb-5 text-white m-5">
            <span className="font-bold text-white text-1xl">
            ...
            Well-versed in using Git for version control and collaboration.
          </p>
          <p className="pb-5 text-white m-5">
            <span className="font-bold text-white text-1xl">DevOps:</span>
